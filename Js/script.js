...
posicionActualBola = posicionInicialBola;
...
//Mover al usuario por el tablro
...
//Anadir evento escuchador para el documento
...
function revisarColisiones() {
  ...
  for (let i = 0; i < bloques.length; i++) {
    if (
      ...
      posicionActualBola[0] < bloques[i].bottomRigth[0] &&
